...
export default function StoreLinkCard() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-[#192250] p-5 text-white shadow-[0_16px_40px_-12px_rgba(15,23,42,0.55)] ring-1 ring-white/10">
      <div
      ...
      <div className="relative">
        <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#8394DB]">
        ...
        <div className="flex items-center justify-between gap-2 rounded-xl bg-[#8394DB] px-3 py-2.5">
